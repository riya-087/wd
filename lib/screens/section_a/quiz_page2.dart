...
class _Page2State extends State<Page2> {
  ...
  void initState() {
    ...
    // Check if timer already has onFinish callback (set in Page1)
    // If not, set it now (edge case if user directly lands here)
  ...
  void _autoNavigateToSectionB() {
    ...
    if (_selectedAnswer != null) {
      answersSoFar['sectionAAnswers']['Q2'] = question2.options[_selectedAnswer!];
    }
                      ...
                      ElevatedButton(
                        onPressed: remaining > 0
                            ? () {
                                ...
                                if (_selectedAnswer != null) {
                                  answersSoFar['sectionAAnswers']['Q2'] =
