...
class _Page3State extends State<Page3> {
  ...
  void initState() {
    ...
    // ✅ FIXED: UI Timer for updating display only
    uiTimer = Timer.periodic(const Duration(seconds: 1), (_) {
      if (mounted) setState(() {});
    });

    // ✅ FIXED: Check if already timeout (consistent with Page2/Page4)
  ...
  void _autoNavigateToSectionB() {
    ...
    if (_selectedAnswer != null) {
      ...
      answersSoFar['sectionAAnswers'] ??= {};
      answersSoFar['sectionAAnswers']['Q3'] = question3.options[_selectedAnswer!];
    }
  ...
  Widget build(BuildContext context) {
    ...
    // ✅ FIXED: Check for timeout during rebuild (consistent with Page2/Page4)
                      ...
                      ElevatedButton(
                        onPressed: remaining > 0
                            ? () {
                                ...
                                // ✅ ADDED: Null-safety check before saving
                                if (_selectedAnswer != null) {
                                  answersSoFar['sectionAAnswers'] ??= {};
