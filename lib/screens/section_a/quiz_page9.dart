...
class _Page9State extends State<Page9> {
  ...
  void _autoNavigateToSectionB() {
    ...
    if (_selectedAnswer != null) {
      answersSoFar['sectionAAnswers']['Q9'] = question9.options[_selectedAnswer!];
    }
                ...
                children: [
                  ...
                  Expanded(
                    child: ListView.builder(
                      itemCount: question9.options.length,
                      ...
                      ElevatedButton(
                        onPressed: remaining > 0  // ✅ CRITICAL FIX: Added timeout check
                            ? () {
                                ...
                                if (_selectedAnswer != null) {
                                  answersSoFar['sectionAAnswers']['Q9'] =
                                      question9.options[_selectedAnswer!];
                                }
