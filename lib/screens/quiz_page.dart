...
class QuizPage1 extends StatefulWidget {
  ...
  const QuizPage1({super.key, this.remainingTime});

  @override
  State<QuizPage1> createState() => _QuizPage1State();
}

class _QuizPage1State extends State<QuizPage1> with TickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    _remainingTime = widget.remainingTime ?? 10 * 60;
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                Page2(remainingTime: _remainingTime),
                          ),
                        );
                      },
